...
Data_TitleScreen:
	...
	.incbin "stages/data/TitleScreen_BPL.bin"

	PaletteOBJ_TitleScreen:
	.incbin "stages/data/TitleScreen_OPL.bin"
...
Data_Stage01_A:
	...
	PaletteBG_Stage01_A:
	.incbin "stages/data/Stage01_A_BPL.bin"
...
Data_Stage01_B:
	...
	PaletteBG_Stage01_B:
	.incbin "stages/data/Stage01_B_BPL.bin"

	PaletteOBJ_Stage01:
	.incbin "stages/data/Stage01_OPL.bin"
...
Data_Stage03_A: ; $68b8
	...
	PaletteBG_Stage03_A:
	.incbin "stages/data/Stage03_A_BPL.bin"
...
Data_Stage03_B:
	...
	PaletteBG_Stage03_B:
	.incbin "stages/data/Stage03_B_BPL.bin"

	PaletteOBJ_Stage03:
	.incbin "stages/data/Stage03_OPL.bin"
...
Data_Stage02_A:
	...
	PaletteBG_Stage02_A:
	.incbin "stages/data/Stage02_A_BPL.bin"
...
Data_Stage02_B:
	...
	PaletteBG_Stage02_B:
	.incbin "stages/data/Stage02_B_BPL.bin"

	PaletteOBJ_Stage02:
	.incbin "stages/data/Stage02_OPL.bin"
...
Data_Stage04_A:
	...
	PaletteBG_Stage04_A:
	.incbin "stages/data/Stage04_A_BPL.bin"
...
Data_Stage04_B:
	...
	PaletteBG_Stage04_B:
	.incbin "stages/data/Stage04_B_BPL.bin"

	PaletteOBJ_Stage04:
	.incbin "stages/data/Stage04_OPL.bin"
...
Data_Ending:
	...
	PaletteBG_Ending:
	.incbin "stages/data/Ending_BPL.bin"

	PaletteOBJ_Ending:
	.incbin "stages/data/Ending_OPL.bin"
...
Data_BlankScreen: 
	...
	.incbin "stages/data/BlankScreen_BPL.bin"

	PaletteOBJ_BlankScreen:
	.incbin "stages/data/BlankScreen_OPL.bin"
